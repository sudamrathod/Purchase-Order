...
doctype_js = {
	"Subscription":"custom_script/subscription/subscription.js"
}
doctype_js ={
	"purchase_order":"public/js/purchase_orders.js"
}
...
doc_events = {
	"Subscription":{
		"validate":"payments.custom_script.subscription.subscription.validate"
	}
}
# doc_events = {
# 	"*": {
...
scheduler_events = {
	"cron":{
		"10 17 * * *":[
			"payments.custom_script.subscription.subscription.scheduler_email"
		]
	}
}
